...
def main():
    ...
    # CSS para un contenedor de 600px de ancho, centrado horizontal y con texto centrado
    st.markdown("""
    <style>
    .block-container {
        max-width: 600px;
    ...
    if st.session_state.resultado:
        ...
        # Imagen centrada + label debajo
        st.markdown(f"""
        <div style="text-align:center; margin:20px 0;">
            <img src="{r['file']}" alt="{r['nombre']}" style="display:block; margin:0 auto; width:180px;"/>
            <h2 style="margin-top:10px;">{r['nombre']}</h2>
        </div>
        """, unsafe_allow_html=True)
