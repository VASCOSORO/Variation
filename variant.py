...
# Ocho sectores con imagen estilo “Mario 3” (de ejemplo)
# Usé iconos random de Icons8 como placeholders. Reemplazalos por lo que quieras.
WHEEL_SECTORS = [
    {
        "label": "5% Descuento",
        "color": "#47a8bd",
        "icon": "https://img.icons8.com/external-wanicon-lineal-color-wanicon/64/external-discount-supermarket-wanicon-lineal-color-wanicon.png"
    },
    {
        "label": "7% Descuento",
        "color": "#47a8bd",
    ...
    },
    {
        ...
        "color": "#47a8bd",
        "icon": "https://img.icons8.com/external-flaticons-flat-flat-icons/64/external-teddy-bear-vacation-planning-flaticons-flat-flat-icons.png"
    },
    {
        "label": "Ganaste un Juguete",
        "color": "#47a8bd",
        "icon": "https://img.icons8.com/doodle/64/puzzle.png"
    },
    {
        "label": "Sin premio",
        "color": "#47a8bd",
        "icon": "https://img.icons8.com/emoji/64/question-mark-emoji.png"
    },
    {
        "label": "Sin premio",
        "color": "#47a8bd",
...
def generar_ruleta_html(angle):
    """
    Genera el HTML/CSS de la ruleta con clip-path y un icono en cada slice.
    'angle' es la rotación total (grados) para simular el giro.
    """
    slices_html = []
    ...
    /* Cada slice con clip-path para cuña de 45° */
    .slice {{
        width: 100%;
        height: 100%;
        position: absolute;
    ...
    /* Contenido de la porción: icono + label */
    .slice-content {{
        position: absolute;
        top: 0;
        left: 50%;
        transform: rotate(-22.5deg); /* Para que quede horizontal */
...
def modulo_ruleta():
    st.title("Ruleta estilo Mario Bros 3 (Íconos en cada porción)")

    st.write("""
    Cada sector tiene un ícono distinto (tipo Mario). 
    Giramos 5 vueltas cada tirada, con un color único de fondo.
    """)
    ...
    if st.button("¡Tirar la Ruleta!"):
        ...
        # 5 vueltas = 5*360=1800°, + chosen_index*45°, + offset random
        ...
        with st.spinner("Girando la ruleta..."):
            time.sleep(4)  # coincide con la transición (4s)

    # Mostramos la ruleta con su ángulo
...
if __name__ == "__main__":
    st.set_page_config(page_title="Ruleta Mario Bros 3", layout="centered")
    modulo_ruleta()
